...
public class AddUser extends javax.swing.JFrame {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        try 
        {
            ...
            if(model.addUser(nname, nschool, ntype, nuser, npass))
            {
                JOptionPane.showMessageDialog(null, "User Added Successfully", "Success",1);
                this.dispose();
                new ManageUser().setVisible(true);
            }
            else
            {
                JOptionPane.showMessageDialog(null, "Failed to add user", "Failed",2);
                this.dispose();
                new ManageUser().setVisible(true);
            }
        }
